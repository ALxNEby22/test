       ...
       <div id="site_page" class="main nopad">
        <div id="admin_site_page_add_content_title_overflow">
         <div id="admin_site_page_add_content_title_overflow_left">
          <div id="admin_site_page_add_content_title">Создание страницы</div>
         </div>
        ...
        <div id="admin_site_page_add_content">
         <div id="admin_site_page_add_short_url_content">
          <input iplaceholder="Введите название страницы. Например: Правила" id="admin_site_page_add_name" type="text">
          <div></div>
         ...
         <div id="admin_site_page_add_save">
          <div id="admin_site_page_add_short_url_f"><? echo $site_url; ?>page/<input iplaceholder="короткий адрес страницы" id="admin_site_page_add_short_url" type="text"></div>
          <div onclick="admin_pages._add();" id="admin_site_page_add_save_button" class="blue_button_wrap small_blue_button"><div class="blue_button">Создать страницу</div></div>
